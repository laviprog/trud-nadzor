...
export const metadata: Metadata = {
  ...
  description:
    'Подготовка к аттестации / проверке знаний в Ростехнадзоре по промышленной безопасности, электробезопасности и теплоэнергетике. Аттестация сотрудников в Ростехнадзоре. Подготовка потрудников к аттестации в РТН. Получите доступ к билетам, тестам с ответами и профессиональному обучению. Услуги по обучению и тестированию в Ростехнадзоре. Проверка знаний РТН. Аттестовать электрика / теплоэнергетика.',
  keywords: [
    'Ростехнадзор',
