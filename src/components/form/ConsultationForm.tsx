...
export default function ConsultationForm() {
  ...
  return success ? (
    <p data-aos="fade-up" data-aos-delay="200" className="text-center font-medium lg:text-5xl text-3xl">
      Спасибо!
    ...
    <>
      ...
      <p data-aos="fade-up" data-aos-delay="200" className="text-center text-lg max-md:text-base">
