...
const trainingSteps = [
  {
    title: 'Оценка знаний',
    description:
      'Начинаем с диагностики: оцениваем текущий уровень, выявляем пробелы и выбираем оптимальный маршрут подготовки.',
    icon: <FileSearchIcon className="w-7 h-7" />,
  },
  {
    title: 'Обучение с экспертами',
    description:
      'Вы проходите углублённый курс под руководством опытных преподавателей и экспертов в своей области.',
  ...
  },
  {
    ...
    description:
      'Вы уверенно проходите аттестацию, чувствуя поддержку команды и опираясь на качественную подготовку — всё ради реального результата.',
